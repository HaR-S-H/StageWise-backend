    ...
    public partial class FixCascadeIssue : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StageMasters", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CabinNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_Users_AdvisorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HODDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HODDetails_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HODDetails_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectStages_StageMasters_StageTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Groups_ProjectStages_CurrentStageId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Groups_Users_CaptainId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupStageProgress", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupStageProgress_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupStageProgress_ProjectStages_ProjectStageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StageDocuments_GroupStageProgress_GroupStageProgressId",
                        column: x => x.GroupStageProgressId,
                        principalTable: "GroupStageProgress",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Groups_CaptainId",
                table: "Groups",
                column: "CaptainId");

            migrationBuilder.CreateIndex(
                name: "IX_Groups_CurrentStageId",
                table: "Groups",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupStageProgress_GroupId",
                table: "GroupStageProgress",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupStageProgress_ProjectStageId",
                table: "GroupStageProgress",
                column: "ProjectStageId");

            migrationBuilder.CreateIndex(
                name: "IX_HODDetails_DepartmentId",
                table: "HODDetails",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_HODDetails_UserId",
                table: "HODDetails",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectStages_StageTypeId",
                table: "ProjectStages",
                column: "StageTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_StageDocuments_GroupStageProgressId",
